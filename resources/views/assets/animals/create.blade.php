      ...
      <div class="card-body p-3">
        <form method='POST' action="{{ route('animals.store') }}">
          ...
          <div class="row">
            ...
            <div class="mb-3 col-md-6">
              <label class="form-label>">{{ __('animal.rfid_id') }}</label>
              <select id="rfid_id" name="rfid_id" class="form-control border border-2 p-2 {{ $errors->has('rfid_id') ? ' is-invalid' : '' }}" required>
